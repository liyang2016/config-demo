...
/**
 * @version v 1.0 on 2016/11/9 14:20
 * @auther william.xu
 */
public class ZipUtil {
	...
	public static String zip(String src, String dest, boolean isCreateDir, String passwd) {
		...
		try {
			...
			if (srcFile.isDirectory()) {
				...
				// parameters.setRootFolderInZip("xxx\\yyy");
	...
	public static InputStream getInputStream(String file, String dest, String passwd) throws Exception {
		ZipFile zipFile = new ZipFile(dest);
		FileHeader fileHeader = zipFile.getFileHeader(file);
		if (fileHeader.isEncrypted()) {
			fileHeader.setPassword(passwd.toCharArray());
		}
